...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <%--编写数据增加表单--%>
            <form action="<%=basePath%>/pages/back/AdminAbsentServlet/Grade" method="post" class="form-horizontal" id="decreaseForm">
                <div class="form-group">
                    <label for="mark" class="col-md-3 control-label">班级:</label>
                    <div class="col-md-3">
